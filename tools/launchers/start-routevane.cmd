...
if not exist "%~dp0routevane.exe" (
    echo Missing routevane.exe. Extract the whole archive.
    goto :failed
)
...
"%~dp0routevane.exe" serve --port "%ROUTEVANE_PORT%" --open-browser=%ROUTEVANE_OPEN_BROWSER%
