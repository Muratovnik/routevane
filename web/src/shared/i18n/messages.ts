...
const ru: Dictionary = {
  ...
  'servicePicker.group.selected': 'Выбрано в маршрут',
  'servicePicker.group.available': 'Доступные списки',
  'servicePicker.include.aria': 'Добавить {list} в маршрут',
  'servicePicker.exclude.aria': 'Убрать {list} из маршрута',
  ...
  'list.priority.title': 'В маршруте',
...
const en: Dictionary = {
  ...
  'servicePicker.group.selected': 'Selected for the route',
  'servicePicker.group.available': 'Available lists',
  'servicePicker.include.aria': 'Add {list} to the route',
  'servicePicker.exclude.aria': 'Remove {list} from the route',
  ...
  'list.priority.title': 'In the route',
