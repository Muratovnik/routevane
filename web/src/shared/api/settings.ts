...
export const loadSettings = (): Promise<DefaultSchedule> =>
  getJSON('/v1/settings', parseSettings)

export const saveDefaultRefreshInterval = (
  interval: RefreshInterval,
): Promise<DefaultSchedule> =>
  postJSON('/v1/settings/update', { refresh_interval: interval }, parseSettings)
